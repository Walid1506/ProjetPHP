...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 13 mars 2025 à 08:41
...
('ACT001', 'Conférence sur la pharmacologie', '2025-03-20', 'PharmaConf 2025', 'Paris'),
('ACT002', 'Séminaire sur les anti-inflammatoires', '2025-04-05', 'InflammaStop', 'Lyon'),
('ACT003', 'Atelier sur les interactions médicamenteuses', '2025-04-10', 'MediInteract', 'Toulouse');
...
INSERT INTO `inscription` (`idActivite`, `idUtilisateur`, `date_inscription`) VALUES
('ACT001', 'USR001', '2025-03-15'),
('ACT002', 'USR002', '2025-03-18'),
('ACT003', 'USR003', '2025-03-20');
...
INSERT INTO `utilisateur` (`idUtilisateur`, `nom`, `prenom`, `email`) VALUES
('USR001', 'Dupont', 'Marie', 'marie.dupont@example.com'),
('USR002', 'Martin', 'Lucas', 'lucas.martin@example.com'),
('USR003', 'Durand', 'Sophie', 'sophie.durand@example.com');
COMMIT;
